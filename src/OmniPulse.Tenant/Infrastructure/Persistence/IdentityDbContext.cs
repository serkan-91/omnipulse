...
using OmniPulse.Tenant.Infrastructure.Persistence.Configurations;
using OmniPulse.BuildingBlocks.Interfaces;
using OmniPulse.BuildingBlocks.Extensions;

namespace OmniPulse.Tenant.Infrastructure.Persistence;
...
{ 
    ...
    public DbSet<OmniPulse.Tenant.Domain.Entities.Tenant> Tenants => Set<OmniPulse.Tenant.Domain.Entities.Tenant>();
